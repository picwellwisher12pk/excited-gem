      ...
      <div className="py-2 space-y-4">
        ...
        <div>
          <div className="flex justify-between text-xs text-gray-500 mb-1">
            <span>
              {progress?.currentStepName ||
                (isRunning ? 'Processing steps...' : 'Completed')}
            </span>
            <span>
              {progress
          ...
          <Progress
            percent={percent}
            status={
              isRunning ? 'active' : result?.success ? 'success' : 'exception'
            }
            showInfo={false}
